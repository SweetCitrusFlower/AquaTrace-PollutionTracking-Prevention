    ...
    <div className="px-4 md:px-10 py-6 max-w-6xl mx-auto space-y-12">
      ...
      <section className="bg-sand-light dark:bg-[#1f2937] rounded-3xl p-6 md:p-10 shadow-soft border border-grass/20 dark:border-[#374151]">
        <div className="flex items-center gap-2 mb-2">
          ...
          <h2 className="font-display text-2xl font-bold text-gray-900 dark:text-gray-100">Choose your plan</h2>
        </div>
        <p className="text-gray-500 dark:text-gray-400 text-sm mb-6 max-w-2xl">
          Citizens get the essentials free, forever. Small farms, NGOs and researchers unlock real-time
          feeds and 12 months of history on Premium. Corporations and institutions get full API access,
          private IoT integration and AI-driven predictive analytics on Enterprise.
        </p>
        <PlanToggle />
      </section>
    </div>
