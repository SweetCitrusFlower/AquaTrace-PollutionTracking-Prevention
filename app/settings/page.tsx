  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-br from-dusk to-dusk-dark text-sand-light rounded-3xl p-6 shadow-fab">
        ...
        <h2 className="font-display text-2xl font-bold mb-1">Real-time data + 12-month history</h2>
        <p className="text-sm opacity-80 mb-5">
          For small farms, NGOs and researchers who need live sensor feeds, custom alerts (SMS/email),
      ...
      {/* Enterprise teaser */}
      <div className="bg-gray-900 dark:bg-gray-800 text-white rounded-3xl p-6 shadow-fab">
        <div className="flex items-center gap-2 mb-2">
          <span className="text-xs font-bold tracking-widest uppercase opacity-90">Enterprise</span>
        </div>
        <h2 className="font-display text-2xl font-bold mb-1">API access &amp; private IoT integration</h2>
        <p className="text-sm opacity-70 mb-5">
          For corporations, governments and institutions. Bring your own sensors, integrate via API,
          unlock AI-driven predictive analytics for entire watersheds.
        </p>
        <button className="bg-white text-gray-900 px-5 py-3 rounded-2xl font-bold shadow-soft active:scale-95 transition">
          Contact sales
        </button>
      </div>
